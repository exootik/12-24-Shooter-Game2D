...
/////////////////////////////////////////////////////////////////////////
void GCInputSystem::Update(MyWindow* pWindow)
{
    m_pKeyboard->Update(pWindow);
    m_pMouse->Update(pWindow);
...
////////////////////////////////////////////////////////
void GCKeyboardInputManager::Update(MyWindow* pWindow)
{
...
/////////////////////////////////////////////////////////
void GCMouseInputManager::Update(MyWindow* pWindow)
{
    for ( int i = 0; i < GCMOUSE::MOUSEIDCOUNT; i++ )
    {
        if ( GetAsyncKeyState(i) != 0 )
    ...
    mousePos.x -= pWindow->GetPos().GetX();
    mousePos.y -= pWindow->GetPos().GetY();
    m_mousePos.x = mousePos.x;
    m_mousePos.y = mousePos.y;
    ...
    if (m_mousePos.y < 0)
        m_mousePos.y = 0;
    if (m_mousePos.x > pWindow->GetWidth())
        m_mousePos.x = pWindow->GetWidth();
    if (m_mousePos.y > pWindow->GetHeight())
        m_mousePos.y = pWindow->GetHeight();
}
#pragma endregion
